...
find_library(myPMSort_LIBRARY
	NAMES myPMSort
	HINTS ${myPMSort_ROOT}/lib
	DOC "The myPMSort library"
)

if(myPMSort_INCLUDE_DIR AND myPMSort_LIBRARY)
...
find_package_handle_standard_args(myPMSort DEFAULT_MSG myPMSort_INCLUDE_DIR myPMSort_LIBRARY)

if(myPMSort_FOUND)
	set(myPMSort_LIBRARIES ${myPMSort_LIBRARY} )
	set(myPMSort_INCLUDE_DIRS ${myPMSort_INCLUDE_DIR} )
endif()

# Tell cmake myPMSorts to ignore the "local" variables
mark_as_advanced(myPMSort_INCLUDE_DIR myPMSort_LIBRARY)
